        ...
        <div className="mt-8 grid grid-cols-1 gap-4 md:grid-cols-3 md:gap-8">
          ...
          >
            <div className="flex items-center gap-4">
              <img
                alt=""
                src="https://b.zmtcdn.com/data/collections/edd5abbddd239a8cfb8099c63b1baaf0_1675247359.jpg"
          ...
          {/* Repeat for other testimonial blocks with animations */}
          <motion.blockquote
            className="rounded-lg bg-gray-50 p-6 shadow-sm sm:p-8"
            initial={{ opacity: 0 }}
            animate={{ opacity: 1 }}
          ...
          {/* Add more testimonials with animation */}
        </div>
      </div>
    </section>
  );
