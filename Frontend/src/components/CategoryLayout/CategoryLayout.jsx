  ...
  const categories = [
    {
      ...
      title: 'Spiced Haleem',
      category: 'Mains',
      imageUrl: 'https://www.teacupsfull.com/cdn/shop/articles/Screenshot_2023-09-05_at_7.00.35_PM.png?v=1693987070&width=1100',
    ...
    },
    {
      ...
      category: 'Snacks',
      imageUrl: 'https://media-cdn.tripadvisor.com/media/photo-m/1280/17/63/f2/a6/cold-coffee-shake-at.jpg',
    ...
    },
    {
      ...
      category: 'Snacks',
      imageUrl: 'https://media1.popsugar-assets.com/files/thumbor/LcyhWxWWfX3NR9c2Yj9sa6fqF0M=/fit-in/792x1188/filters:format_auto():upscale()/2018/04/30/138/n/1922195/tmp_b4GFOH_533ec234d70d6d4b_Triple_Mocha_Frappuccino.jpg',
    ...
    },
    {
      ...
      category: 'Mains',
      imageUrl: 'https://centerforfamilymedicine.com/wp-content/uploads/2018/11/Center-for-Family-Medicine-Sherman-Texas-3-Dangers-Of-Overeating-At-Thanksgiving.jpg',
  ...
  return (
    <section className="py-12 bg-beige-100">
      <div className="mx-auto max-w-screen-xl px-4 sm:px-6 lg:px-8">
        ...
        >
          <h2 className="text-lg sm:text-xl font-semibold text-gray-700 uppercase tracking-wide">
              ...
              >
                ...
                <div className="p-4">
                  <div className="flex items-center justify-between mb-2">
                    <span className="text-xs uppercase text-gray-500">{category.category}</span>
        ...
        <div className="text-center mt-8">
          <motion.button
            className="px-6 py-2 bg-gray-200 text-gray-800 font-medium rounded-md hover:bg-gray-300 transition-colors duration-300"
