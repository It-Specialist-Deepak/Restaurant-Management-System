...
const PermitRoomSection = () => {
  return (
    <section className="flex flex-col lg:flex-row items-center justify-between bg-yellow-200 p-10 lg:p-20 border-t-8 border-b-8 border-black">
      {/* Left Content */}
      <div className="lg:w-1/2 text-center lg:text-left">
        ...
        <div className="w-12 h-12 border-l-2 border-gray-800 my-4 mx-auto lg:mx-0"></div>
        <p className="text-gray-800 max-w-lg mx-auto lg:mx-0 text-lg">
          An all-day bar café – a salute to Bombay’s colourful history of drinking and revelry.
        </p>
        <a
          href="#"
          className="inline-block mt-6 text-lg font-semibold text-gray-900 border-b-2 border-gray-900 hover:border-gray-700"
        >
          Read more
        </a>
      </div>
